...
export default function Contact() {
  return (
    <section id="contact" className="container space-y-8 py-12 md:py-24 animate-in fade-in-up duration-1000">
      ...
      <div className="grid md:grid-cols-2 gap-10">
        <div className="flex flex-col gap-8 animate-in fade-in-up duration-500 delay-200">
