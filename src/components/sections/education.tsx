...
export default function Education() {
  return (
    <section id="education" className="container space-y-8 py-12 md:py-24">
      ...
      <div className="grid grid-cols-1 gap-8 md:grid-cols-2 lg:grid-cols-3 animate-in fade-in-up duration-500 delay-200">
        {educationData.map((edu, index) => (
          <Card key={edu.degree} className="flex flex-col overflow-hidden rounded-lg transition-all duration-300 hover:border-primary hover:shadow-lg hover:shadow-primary/20 hover:-translate-y-2">
            <CardHeader>
